...
def _copyargs_callback(ctx: FunctionContext) -> Type:
    """
    Copy the signature of the type of the argument of the call to the signature
    of the return type.  This is appropriate for function/method decorators
    which can be used on functions/methods with variable signatures and simply
    change the return type while passing through all arguments unchanged.
